	...
	return (
		<article className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-vanilla-700 dark:bg-rich_black-300 p-4 rounded border shadow-md shadow-rich_black-600 dark:shadow-rufous">
			<div className="flex items-center justify-between space-x-2 mb-1">
				<h2 className="font-bold text-rich_black-100 dark:text-rufous text-[2.3vmax] md:text-[2.2vmax] xl:text-[2.1vmax]">{title}</h2>
			...
			<div className="pt-5 text-rich_black-100 dark:text-rufous text-[1.6vmax]  md:text-[1.4vmax] xl:text-[1.3vmax]">
				{children}
			</div>
		</article>
	);
